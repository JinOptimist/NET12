...
namespace WebMaze.Migrations
{
    ...
    [Migration("20211127214552_CreateConnectionBetweenMovieAndGame")]
    partial class CreateConnectionBetweenMovieAndGame
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameMovie", b =>
                {
                    ...
                    b.Property<long>("MyMoviesId")
                        .HasColumnType("bigint");

                    b.HasKey("GamesId", "MyMoviesId");
            ...
            modelBuilder.Entity("WebMaze.EfStuff.DbModel.Movie", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GameMovie", b =>
                {
                    b.HasOne("WebMaze.EfStuff.DbModel.Game", null)
                        .WithMany()
                        .HasForeignKey("GamesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebMaze.EfStuff.DbModel.Movie", null)
                        .WithMany()
